...
public class AgendaContatos {
    ...
    public static void main(String[] args) {
        ...
        agendaContatos.adicionarContato("Camila Cavalcante", 5665);
        agendaContatos.adicionarContato("Camila", 1111);
        agendaContatos.adicionarContato("Camila DIO", 467890);
        agendaContatos.adicionarContato("Maria Silva", 678890);
